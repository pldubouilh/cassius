...
function login() {
	...
	// Wrong password...
                    ...
                    .delay(10000)
                    .queue(function (n) {
                           $('.wrong').html('<a class="login-link" href="#">You can reset Cassius by flushing your cookies.</a>');
                           n();
                    });
...
$(window).load(function () {
	...
	if (!salt) $('.wrong').html('<div class="login-link">Welcome to Cassius !<br>Input you password here, and remember it.<br />Note that if you flush your cookies, you will loose everything !</div>');
});
